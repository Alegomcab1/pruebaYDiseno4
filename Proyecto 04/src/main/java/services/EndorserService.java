...
public class EndorserService {
	...
	public Endorser createEndorser(String name, String middleName, String surname, String photo, String email, String phoneNumber, String address, String userName, String password, Score score) {
